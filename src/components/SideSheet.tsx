...
export function SideSheet({ isOpen, onClose, title, children, size = 'md' }: SideSheetProps) {
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed right-0 top-0 bottom-0 h-full ${widthClasses[size]} bg-white/95 backdrop-blur-xl z-50 shadow-card border-l border-border-subtle transform transition-transform duration-300 flex flex-col rounded-l-xl`}
      >
