...
import { Search, Filter, RotateCcw, X, Plus, User, UserPlus, BotMessageSquare, Phone, Globe, Languages, Briefcase, MoveLeft } from "lucide-react";
        ...
        <div>
            <div className="space-y-6 my-2">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-3xl font-bold text-text-main">Agents & History</h1>
                            ...
                            {mockAgents.map((agent) => (
                                <div className="card p-5 group hover:shadow-glow transition-all duration-300" key={agent.id}>
                                    ...
                                    <div className="flex gap-2">
                                        <button className="btn btn-primary flex-1 py-1.5 text-xs">
                                            Edit Agent
                                        </button>
                                        <button className="btn btn-secondary flex items-center gap-1.5 py-1.5 text-xs px-3"
                    ...
                    isOpenedCalls && (
                        <div className="card p-4">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 mb-4">
                                <button className="btn btn-secondary bg-primary-soft text-primary flex items-center gap-1.5 py-1.5 text-xs px-3 border-primary"
